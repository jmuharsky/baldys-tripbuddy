...
goog.scope(function() {
  tripbuddy.components.PageSectionStates = function($stateProvider, $locationProvider) {
    ...
    'page.content':{templateUrl:'/components/event/detail/views/content.html'}, 'page.rightwell':{templateUrl:'/components/event/detail/views/rightwell.html'}, 'page.footer':{templateUrl:'/components/event/detail/views/footer.html'}, 'page.toolbar':{templateUrl:'/components/event/detail/views/toolbar.html'}}}).state('locations', {url:'/locations', views:{'page.leftwell':{templateUrl:'/components/location/list/views/leftwell.html'}, 'page.toolbar':{templateUrl:'/components/location/list/views/toolbar.html', 
    controller:'locationListViewCtrl'}, 'page.content':{templateUrl:'/components/location/list/views/content.html', controller:'locationListViewCtrl'}, 'page.rightwell':{templateUrl:'/components/location/list/views/rightwell.html'}, 'page.footer':{templateUrl:'/components/location/list/views/footer.html'}}}).state('location', {url:'/location/:locationId', views:{'page.leftwell':{templateUrl:'/components/location/detail/views/leftwell.html'}, 'page.content':{templateUrl:'/components/location/detail/views/content.html'}, 
    'page.rightwell':{templateUrl:'/components/location/detail/views/rightwell.html'}, 'page.footer':{templateUrl:'/components/location/detail/views/footer.html'}, 'page.toolbar':{templateUrl:'/components/location/detail/views/toolbar.html'}}});
...
goog.scope(function() {
  ...
  LocationDataService.prototype.create = function(location) {
    this.http_({method:'post', url:'/data/location/create', responseType:'json', data:location}).success(angular.bind(this, function(data, status) {
      console.log('data: ');
      console.log(data);
